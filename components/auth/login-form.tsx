...
export default function LoginForm({ initialError = null }: LoginFormProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Login response:", { data: data ? "data present" : "no data", error: loginError })
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      <CardHeader>
        ...
        <CardDescription>Log in to your Health.ai account</CardDescription>
      </CardHeader>
      <CardContent>
        {error && (
          <Alert variant="destructive" className="mb-4">
            <AlertDescription>
              {error.message}
              {error.code && <div className="mt-1 text-xs opacity-80">Error code: {error.code}</div>}
            </AlertDescription>
          </Alert>
        )}
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Button variant="link" className="p-0 h-auto text-sm" onClick={() => router.push("/reset-password")}>
                Forgot password?
              </Button>
            </div>
